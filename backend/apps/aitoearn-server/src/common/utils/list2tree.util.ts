 ...
 * @param value 用于过滤的值
 */
export function filterTree2List(treeData: any[], key: string | number, value: any) {
  const filterChildrenTree = (resTree: any[], treeItem: { [x: string]: string | any[], children: any[] }) => {
