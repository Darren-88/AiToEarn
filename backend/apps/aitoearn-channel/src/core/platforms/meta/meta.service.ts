...
import { OAuth2Credential as OAuth2CredentialModel } from '../../../libs/database/schema/oauth2Credential.schema'
import {
...
export class MetaService {
  ...
  constructor(
    ...
    @InjectModel(OAuth2CredentialModel.name)
    private OAuth2CredentialModel: Model<OAuth2CredentialModel>,
  ) {
  ...
  async selectFacebookPages(
    ...
    for (const pageId of pageIds) {
      ...
      await this.OAuth2CredentialModel.updateOne({
