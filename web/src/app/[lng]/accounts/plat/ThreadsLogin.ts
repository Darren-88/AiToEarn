import qs from 'qs'
import { checkMetaAuthApi, getThreadsAuthUrlApi } from '@/api/platAuth'
 ...
 * @param platType
 */
export async function threadsSkip(platType: PlatType, spaceId?: string) {
  if (platType !== PlatType.Threads)
    return
